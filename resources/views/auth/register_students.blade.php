    ...
    <div class="register-box">
        ...
        <div class="register-box-body">
            ...
            <form action="{{ url('/register') }}" method="post">
                ...
                <div class="form-group">
                    {{ Form::select("college", \Dwij\Laraadmin\LAFormMaker::process_values("@colleges"), "", array("data-placeholder" => "Select College", "rel" => "select2")) }}
                </div>
                <div class="form-group has-feedback">
                    <input type="mobile" class="form-control" placeholder="Mobile" name="mobile" value="{{ old('mobile') }}"/>
