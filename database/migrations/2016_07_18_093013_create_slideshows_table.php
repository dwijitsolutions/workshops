...
class CreateSlideshowsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Slideshows", 'slideshows', 'name', [
            ["name",        "Name",         "Name",     false, "",  5,  256,   true],
            ["course",      "Course",       "Dropdown", false, 3,   0,  0,     false, "@Courses"],
            ["slides",      "Slides",       "Integer",  false, 0,   0,  500,   false],
            ["slides_file", "Slides File",  "String",   false, "",  0,  256,   true],
